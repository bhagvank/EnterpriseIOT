...
converter::converter(const char *id, const char *host, int port) : mosquittopp(id)
{
	int keepalive = 60;
...
void converter::on_connect(int rc)
{
...
void converter::on_message(const struct mosquitto_message *message)
{
...
void converter::on_subscribe(int mid, int qos_count, const int *granted_qos)
{
